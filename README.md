...
|--------|--------------|------------------------------------------------|
| 序号   | 视频序号     | 1                                              |
| 标题   | 视频标题     | 抓取B站数据 AI分析 开源工具                    |
| BV 号  | 视频唯一标识 | BV1wRivBFExQ                                   |
| 链接   | 视频完整链接 | https://www.bilibili.com/video/BV1wRivBFExQ    |
| 封面   | 封面图片 URL | https://i2.hdslb.com/bfs/archive/0c2a0100b3... |
| 时长   | 视频时长     | 10:20                                          |
| 播放量 | 播放次数     | 12                                             |
| 发布时间 | 发布日期   | 2026-01-03                                     |
...
导出后可直接用 Excel、WPS 或其他表格软件打开，方便进行数据分析和整理。
...
本工具的初衷是帮助 UP 主收集自己的视频数据，用于 AI 分析、总结、整理和汇总。请勿用于任何不正当用途，使用时须遵守相关法律法规与平台规则，由此产生的后果由使用者自行承担。
